...
- Die Daten stammen aus `data/slides.json` und folgen exakt der im Handbuch dokumentierten Struktur (Layout-Block mit `active_layout`, `thumbnail_url`, `content`, dazu Audio-Playlists und Notiz-Links).
